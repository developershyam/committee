...
public class table extends JFrame {
	...
	static String _header[];//={"h1","h2","h3","h4","h5","h6"};
	String _name;
	static String _data[][];
    /**
     * Constructs an instance of the demo.
     */
    public table(String n,String h[],String d[][]) {
        ...
        headerField = new JTextField(_name);
    ...
    public static void main(final String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
				...
				String s1[]={"h1","h2","h3","h4","h5","h6"};
                String s2[][]={{"ss","ss","sddd","sss","rr","tt"},{"ss","ss","sddd","sss","rr","tt"}};
                ...
                new table("Monthly report",s1,s2).setVisible(true);
    ...
    private static class GradesModel implements TableModel {
        private final Object[][] GRADES = _data;
			/*{
