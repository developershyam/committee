...
import java.util.*;
public class BorrowerAccount extends javax.swing.JInternalFrame {
    ...
    public BorrowerAccount(JFrame mainframe) {
        super("Borrower Account",true,true,true,true);
        ...
        try {
            ...
            db.rslt=db.stmt.executeQuery("select br_id,br_no from borrower where lottery_no='"+lottery.elementAt(c_lottery.getSelectedIndex())+"'");
            db.rslt.afterLast();
            int count=0;
            ...
            _membername.clear();
            _memberid.clear();
            db.rslt=db.stmt.executeQuery("select borrower.br_id,borrower.name,borrower.br_no from borrower where  borrower.lottery_no='"+lottery.elementAt(c_lottery.getSelectedIndex())+"'");
            while(db.rslt.next())
            {
            ...
            db.rslt=db.stmt.executeQuery("select name from borrower where br_id='"+member_id.elementAt(c_member.getSelectedIndex())+"'");
            if(db.rslt.next()) {
            ...
            db.rslt=db.stmt.executeQuery("select date,debit,credit,interest,balance from borrowersheet where br_id='"+member_id.elementAt(c_member.getSelectedIndex())+"'");
            db.rslt.afterLast();
            if(db.rslt.previous())count=db.rslt.getRow();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Borrower Detail")));
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addGap(13, 13, 13)
                                        .addComponent(tf_interest, javax.swing.GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE))
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(tf_credit, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addGap(3, 3, 3)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(tf_debit, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(tf_max, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(202, 202, 202))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tf_available, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(34, 34, 34)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                .addComponent(tf_date, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(bt_date, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(r_debit, javax.swing.GroupLayout.Alignment.LEADING))
        ...
        l_investment.setText("Total Credit :");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(l_investment, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                    .addComponent(l_debit, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                    .addComponent(l_interest, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                    .addComponent(l_balance, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel1, 0, 1029, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel5, 0, 285, Short.MAX_VALUE)
...
,currentbalance);
        ...
        tf_interest.setText(interest+(olddebit+oldinterest-oldcredit-currentbalance)+"");
        tf_max.setText((tbalance+interest+(olddebit+oldinterest-oldcredit-currentbalance))+"");
...
,currentbalance);
        ...
        tf_interest.setText((olddebit+oldinterest-oldcredit-currentbalance)+interest+"");
        Dbcon db=new Dbcon();
        db.connect();
        try
        {
            if(r_credit.isSelected())
            {
                if(credit>currentbalance+interest+(olddebit+oldinterest-oldcredit-currentbalance))
                {
                ...
                db.stmt.executeUpdate("insert into borrowersheet(lottery_no,br_id,date,debit,credit,interest,balance) "+
...
+"',0,"+credit+","+interest+","+(currentbalance+(olddebit+oldinterest-oldcredit-currentbalance)+interest-credit)+")");
          
                //db.stmt.executeUpdate("insert into investsheet(lottery_no,investor_id,date,debit,credit,interest,balance) "+
                // "values('"+lottery.elementAt(c_lottery.getSelectedIndex())+"',"+member_id.elementAt(c_member.getSelectedIndex())+",'"+tf_date.getText()+"',0,"+credit+","+interest+","+(currentbalance+credit)+")");
            ...
            if(r_debit.isSelected())
            {
                ...
                db.stmt.executeUpdate("insert into borrowersheet(lottery_no,br_id,date,debit,credit,interest,balance) "+
                 "values('"+lottery.elementAt(c_lottery.getSelectedIndex())+"',"+member_id.elementAt(c_member.getSelectedIndex())+",'"+DateConverter.toYYYYMMDD(tf_date.getText())
+"',"+debit+",0,"+interest+","+(currentbalance+debit)+")");
    ...
    private void c_memberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c_memberActionPerformed
        ...
        db.connect();
        try {
            db.rslt=db.stmt.executeQuery("select name from borrower where investor_id='"+member_id.elementAt(c_member.getSelectedIndex())+"'");
            if(db.rslt.next()) {
               tf_name.setText(db.rslt.getString(1));
            }
