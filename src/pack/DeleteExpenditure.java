...
import java.util.*;
public class DeleteExpenditure extends javax.swing.JInternalFrame {
    ...
    JPanel p1[],p2[];
    JPanel panel;
    public DeleteExpenditure(JFrame mainframe) {
        super("Delete Expenditure",true,true,true,true);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Expenditure");
