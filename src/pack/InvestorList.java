...
import java.util.*;
public class InvestorList extends javax.swing.JInternalFrame {

    /** Creates new form MemberList */
    JFrame mainframe;
    int member_id;
    public InvestorList(JFrame mainframe) {
        super("Investor List",true,true,true,true);
		...
		Dbcon db=new Dbcon();
                ...
                try
                {
                        db.rslt=db.stmt.executeQuery("SELECT investoraccount.investor_no,investorinfo.name,investorinfo.f_name,investorinfo.address,investorinfo.contact_no from lottery2.investorinfo,lottery2.investoraccount where investorinfo.investor_id=investoraccount.investor_id and investoraccount.status=1  and investoraccount.lottery_no='"+lottery.elementAt(c_lottery.getSelectedIndex())+"' order by investorinfo.name");
                        db.rslt.afterLast();
                        int count=0;
		...
		Object[] columnNamess = {"S.N.","Investor ID","Name","Father's Name","Address","Contact No."};
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(bt_date, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tf_nameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf_nameActionPerformed
        // TODO add your handling code here:
         Dbcon db=new Dbcon();
                ...
                try
                {
                        db.rslt=db.stmt.executeQuery("SELECT investoraccount.lottery_no,investoraccount.investor_no,investorinfo.name,investorinfo.f_name,investorinfo.address,investorinfo.contact_no from lottery2.investorinfo,lottery2.investoraccount where investorinfo.investor_id=investoraccount.investor_id  && investoraccount.status=1 && investorinfo.name like '%"+tf_name.getText()+"%'");
                        db.rslt.afterLast();
                        int count=0;
                        if (db.rslt.previous())count=db.rslt.getRow();
                        datas=new Object[count][6];
