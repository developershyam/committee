...
import java.util.*;
public class EditExpenditure extends javax.swing.JInternalFrame {
    ...
    JPanel p1[],p2[];
    JPanel panel;
    public EditExpenditure(JFrame mainframe) {
        super("Edit Expenditure",true,true,true,true);
                ...
                bt[p].addActionListener(new ActionListener(){
                    public void actionPerformed(ActionEvent ae)
                    {
                       try
                       {
                            Dbcon db1=new Dbcon();
                            db1.connect();
                            db1.stmt.executeUpdate("update expenditure set amount="+tf_am[p].getText()+",description='"+ta[p].getText()+"' where sn="+sn[p]);
                            db1.conn.commit();
                            db1.disconnect();
                            JOptionPane.showMessageDialog(mf,"Update Successfully","Successfully",JOptionPane.PLAIN_MESSAGE);
                       }
                       catch(Exception e)
                       {
                            JOptionPane.showMessageDialog(mf,"You Entered Wrong Value","Error",JOptionPane.ERROR_MESSAGE);
                       }
                    }
                });
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Expenditure");
