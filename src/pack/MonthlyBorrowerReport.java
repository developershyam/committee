...
public class MonthlyBorrowerReport extends javax.swing.JInternalFrame {

    /** Creates new form MonthlyReport */
    JFrame mainframe;
Vector recurring,nonrecurring,date,member_id,person,lmonth;
long totalavailable=0;
    public MonthlyBorrowerReport(JFrame mainframe) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Monthly Borrower Report");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(l_ldate, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addComponent(tf_available, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Borrower")));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pageend, javax.swing.GroupLayout.DEFAULT_SIZE, 949, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        db.connect();
        try {
            db.rslt=db.stmt.executeQuery("SELECT ac.br_no,ac.name,s.debit,s.credit,s.interest,s.balance from lottery2.borrower ac,lottery2.borrowersheet s where ac.br_id=s.br_id &&  s.lottery_no='"+lottery.elementAt(c_lottery.getSelectedIndex())+"' && s.date>='"+date1+"' && s.date<='"+date2+"'");
            int c=0;
            db.rslt.afterLast();
            if(db.rslt.previous())c=db.rslt.getRow();
            db.rslt.beforeFirst();
            Object data[][]=new Object[c+1][7];
            long dr=0,cr=0,bal=0,in=0;
            Object header[]={"S.No.","Borrower Id","Name","Debit","Credit","Interest","Balance"};
           int i=0;
            while(db.rslt.next())
            {
                data[i][0]=(i+1)+"";
                ...
                if(db.rslt.getString(3)!=null)
                    dr+=Long.parseLong(db.rslt.getString(3));
                if(db.rslt.getString(4)!=null)
                    cr+=Long.parseLong(db.rslt.getString(4));
                if(db.rslt.getString(5)!=null)
                    in+=Long.parseLong(db.rslt.getString(5));
                if(db.rslt.getString(6)!=null)
                    bal+=Long.parseLong(db.rslt.getString(6));
                i++;
            ...
            {
                {
                    ...
                    table.getColumn("Balance").setCellRenderer(new ButtonRenderer103());
                }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
           ...
           // String header[]={"S.No.","Date","Recurring","Fine","Debit","Credit","Interest","Total Deposite","Balance"};
            String header[]={"S.No.","Borrower Id","Name","Debit","Credit","Interest","Balance"};
            String s2[][]=new String[table.getRowCount()][7];
...
class ButtonRenderer103 extends JComponent implements TableCellRenderer
{
    int x=0,y=0;
    Object value;
    public ButtonRenderer103()
    {
            y=getHeight();
            x=getWidth();
