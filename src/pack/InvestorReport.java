...
public class InvestorReport extends javax.swing.JInternalFrame {

    /** Creates new form MonthlyReport */
    JFrame mainframe;
    Vector date,investor_id,lmonth,debit,credit,interest,balance,name,fname,investor;
    long totalavailable=0;
    public InvestorReport(JFrame mainframe) {
        super("Investor Report",true,true,true,true);
        ...
        try {
            ...
            db.rslt=db.stmt.executeQuery("select ac.investor_id,ac.investor_no,info.name,info.f_name from investoraccount ac,investorinfo info where ac.investor_id=info.investor_id && ac.lottery_no='"+lottery.elementAt(c_lottery.getSelectedIndex())+"'");
            while(db.rslt.next())
            {
            ...
            for(int i=0;i<investor_id.size();i++)
            {
                ...
                db.rslt=db.stmt.executeQuery("select debit,credit,interest,balance from investsheet where investor_id="+investor_id.elementAt(i));
            ...
            Object data[][]=new Object[investor_id.size()+1][8];
            Object header[]={"S.No.","Investor Id","Name","Father's Name","Total Debit","Total Credit","Total Interest","Current Balance"};
            ...
            for(int i=0;i<investor_id.size();i++)
            {
                ...
                data[i][3]=fname.elementAt(i);
                data[i][4]=debit.elementAt(i);
                data[i][5]=credit.elementAt(i);
                data[i][6]=interest.elementAt(i);
                data[i][7]=balance.elementAt(i);
            ...
            data[investor_id.size()][4]=""+_tdr;
            data[investor_id.size()][5]=""+_tcr;
            data[investor_id.size()][6]=""+_ti;
            data[investor_id.size()][7]=""+_tb;
            ...
            //table.getColumn("S.No.").setPreferredWidth(2);
            //table.getColumn("Investor Id").setPreferredWidth(2);
            table.updateUI();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Investor Report");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel2, javax.swing.GroupLayout.Alignment.LEADING, 0, 920, Short.MAX_VALUE)
           ...
           fname.clear();
            ...
            for(int i=0;i<investor.size();i++)
            {
               // if(deposite.elementAt(i)==null)
                {
                    System.out.println("i=="+i);
                    table.getColumn("Current Balance").setCellRenderer(new ButtonRenderer107());
                    //table.getColumn("S.No.").setCellRenderer(new ButtonRenderer1());
                }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String header[]={"S.No.","Investor Id","Name","Father's Name","Total Debit","Total Credit","Total Interest","Current Balance"};
...
class ButtonRenderer107 extends JComponent implements TableCellRenderer
{
    int x=0,y=0;
    Object value;
    public ButtonRenderer107()
    {
            y=getHeight();
            x=getWidth();
