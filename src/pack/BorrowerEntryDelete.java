...
import java.util.*;
public class BorrowerEntryDelete extends javax.swing.JInternalFrame {

    /** Creates new form MemberAccount */
    JFrame mainframe;
    Vector recurring,nonrecurring,date,member_id,sn;
    int tmonth=0,trecurring,tfine,tdebit,tcredit,tinterest,ttotal,tbalance;
    long totalavailable=0;
    int arr[]=null;
    String lastdate="";
    public BorrowerEntryDelete(JFrame mainframe) {
        ...
        try {
           ...
           // person.clear();
            ...
            count=0;
            Object data[][]=null;
            Object header[]={"S.No.","Date","Debit","Credit","Interest Added","Balance"};
            db.rslt=db.stmt.executeQuery("select date,debit,credit,interest,balance,sn from borrowersheet where br_id='"+member_id.elementAt(c_member.getSelectedIndex())+"'");
            db.rslt.afterLast();
            if(db.rslt.previous())count=db.rslt.getRow();
            ...
            while(db.rslt.next())
            {
                ...
                sn.addElement(db.rslt.getString(6));
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(tf_name, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addComponent(tf_available, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(292, 292, 292))
        ...
        l_investment.setText("Total Investment :");
        ...
        l_balance.setText("Total Balance");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(l_investment, javax.swing.GroupLayout.DEFAULT_SIZE, 257, Short.MAX_VALUE)
                    .addComponent(l_debit, javax.swing.GroupLayout.DEFAULT_SIZE, 257, Short.MAX_VALUE)
                    .addComponent(l_interest, javax.swing.GroupLayout.DEFAULT_SIZE, 257, Short.MAX_VALUE)
                    .addComponent(l_balance, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 257, Short.MAX_VALUE))
                .addContainerGap())
        );
            ...
            for (int i=0;i<table.getRowCount();i++) {
                    ...
                    if (b.booleanValue()==true) {
                        ...
                        if (reply == JOptionPane.YES_OPTION) {
                                ...
                                db.stmt.executeUpdate("delete from borrowersheet where sn="+sn.elementAt(i));
